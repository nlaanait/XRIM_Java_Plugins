	...
	public void run(ImageProcessor ip) {
		...
		if(gd.getNextBoolean()){
			...
			for(String sliceLabel : stackLabels){		// Loop over images in stack
				...
				//	infoList = parseSpecFile(specFilePath,sliceLabel); // parse to find metadata for the image
	   			//	IJ.log(infoArray[9]);
		...
		//process a single image copy from v2
	   	...
	   	//	infoList = parseSpecFile(specFilePath,impTitle); // parse to find metadata for the image 
	   	//	do {
	   	//		infoList.remove("");	
	   	...
	   	//	String regexp = "[ ]+";
		//	String[] pfLine =(String)(infoArray[0]);
